...
import { ModalEditor } from "./vim/index.js";
...
export default function powerlineFooter(pi: ExtensionAPI) {
  ...
  function setupCustomEditor(ctx: any) {
    ...
    const editorFactory = (tui: any, editorTheme: any, keybindings: any) => {
      ...
      // Use pi-vim's ModalEditor as the base editor so vim mode and
      // powerline rendering can coexist in a single custom editor.
      const editor = new ModalEditor(tui, editorTheme, keybindings, colorizers);
