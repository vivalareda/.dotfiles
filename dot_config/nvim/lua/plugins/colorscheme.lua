...
return {
  ...
  config = function(_, opts)
    ...
    vim.api.nvim_set_hl(0, "NoiceCmdlinePopup", { bg = "#1F1F1F", fg = "#F9E7C0" })
    vim.api.nvim_set_hl(0, "NoiceCmdlinePopupBorder", { bg = "#1F1F1F", fg = "#F9E7C0" })
    vim.api.nvim_set_hl(0, "NoiceConfirm", { bg = "#1F1F1F", fg = "#F9E7C0" })
    vim.api.nvim_set_hl(0, "NoiceConfirmBorder", { bg = "#1F1F1F", fg = "#F9E7C0" })
    vim.api.nvim_set_hl(0, "NoiceCmdlineIcon", { bg = "#1F1F1F", fg = "#F9E7C0" })

    vim.api.nvim_set_hl(0, "CmpItemAbbr", { fg = "#c0caf5" }) -- Default text
    vim.api.nvim_set_hl(0, "CmpItemAbbrMatch", { fg = "#7aa2f7", bold = true }) -- Match text
    vim.api.nvim_set_hl(0, "CmpItemAbbrMatchFuzzy", { fg = "#7aa2f7", bold = true })
    vim.api.nvim_set_hl(0, "CmpItemKindFunction", { fg = "#c678dd" }) -- Functions
    vim.api.nvim_set_hl(0, "CmpItemKindVariable", { fg = "#e5c07b" }) -- Variables
    vim.api.nvim_set_hl(0, "CmpItemKindKeyword", { fg = "#d19a66" }) -- Keywords
    vim.api.nvim_set_hl(0, "CmpItemKindSnippet", { fg = "#56b6c2" }) -- Snippets
    vim.api.nvim_set_hl(0, "CmpItemKindField", { fg = "#9d7cd8" }) -- Fields
    vim.api.nvim_set_hl(0, "CmpItemKindText", { fg = "#98c379" }) -- Text
  end,
}
